                    ...
                    <div class="product-details-img product-two-gallery position-relative">
                        <div class="row g-3">
                            ...
                            @foreach ($product_details->other_images as $images)
                                @php
                                    $image = dynamic_image($images, 600);
                                    $image_zoom = dynamic_image($images, 800);
                                @endphp
                                <div class="col-lg-6 col-md-6 col-6">
                                    <div class="zoompro-wrap img-100hw">
                                        <div class="zoompro-span">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                    ...
                    <p class="infolinks d-flex-center justify-content-start mb-2">
                        <a class="cursor-pointer text-link remove-favorite rem-fav-btn text-danger {{ $product_details->is_favorite == 0 ? 'd-none' : 'd-flex' }}"
                            data-product-id="{{ $product_details->id }}" data-product-type="combo"><i class="hdr-icon icon anm anm-heart fs-6 me-2"></i><span>{{ labels('front_messages.remove_from_wishlist', 'Remove from Wishlist') }}</span></a>
                        <a class="cursor-pointer text-link add-favorite {{ $product_details->is_favorite == 0 ? 'd-flex' : 'd-none' }}"
                            data-product-id="{{ $product_details->id }}" data-product-type="combo"><i class="hdr-icon icon anm anm-heart-l fs-6 me-2"></i><span>{{ labels('front_messages.add_to_wishlist', 'Add to Wishlist') }}</span></a>
                ...
                <div class="stickyOptions position-relative">
                    <div class="selectedOpt product_price">
                        @php
                            ...
                            $specialPriceValue = isset($product_details->special_price) && $product_details->special_price > 0
                                ? $product_details->special_price
                                : null;

                            // Determine the final price to display
                            $finalPrice = ($specialPriceValue === null || $specialPriceValue >= $priceValue)
                                ? $priceValue
                                : $specialPriceValue;
