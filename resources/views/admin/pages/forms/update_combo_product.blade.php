                                        ...
                                        <div class="col-12 shadow p-3 mb-3 bg-white rounded text-center image">
                                            <div class='image-upload-div'>
                                                <img class="img-fluid mb-2"
                                                    src="{{ route('admin.dynamic_image', ['url' => getMediaImageUrl($data->image), 'width' => 150, 'quality' => 90]) }}"
                                                    alt="Not Found" />
                                            </div>
                                ...
                                <div class="row image-upload-section">
                                    ...
                                    @if (!empty($other_images))
                                        @foreach ($other_images as $row)
                                            <div
                                                class="col-md-6 col-sm-12 shadow p-3 mb-3 bg-white rounded text-center image">
                                                <div class='image-upload-div'>
                                                    <img class="img-fluid mb-2"
                                                        src="{{ route('admin.dynamic_image', ['url' => getMediaImageUrl($row), 'width' => 150, 'quality' => 90]) }}"
                                                        alt="Not Found" />
                                                </div>
