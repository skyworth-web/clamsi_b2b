...
<div>
    ...
    <!--Topbar info-->
    {{-- @if ($settings->shipping_mode == 1 && $settings->return_mode == 1 && $settings->support_mode == 1 && $settings->safety_security_mode == 1)
            ...
            <div class="container-fluid">
                <div class="row text-center text-uppercase infobar-slider-4items">
                    <div class="col-12 col-sm-6 col-md-3 col-lg-3 item d-flex-justify-center">
                        <a>{{ $settings->support_title }}</a>
                    </div>

                    <div class="col-12 col-sm-6 col-md-3 col-lg-3 item d-flex-justify-center">
                        <a>{{ $settings->shipping_title }}</a>
                    </div>
                    <div class="col-12 col-sm-6 col-md-3 col-lg-3 item d-flex-justify-center">
                        <a>{{ $settings->return_title }}</a>
                    </div>
                    <div class="col-12 col-sm-6 col-md-3 col-lg-3 item d-flex-justify-center">
                        <a>{{ $settings->safety_security_title }}</a>
                    </div>
