                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <div class="login-img-box mb-3">
                                <img src="{{ config('app.url') }}storage/{{ $system_settings['logo'] }}" alt="logo" class="img-fluid">
                            </div>
                        ...
                        <form class="form_authentication" class="mb-3 form-submit-event" action="{{ route('admin.password.update') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" maxlength="16" oninput="validateNumberInput(this)" class="form-control" name="mobile" placeholder="Enter Your Mobile Number">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="form-label">{{ labels('admin_labels.new_password', 'New password') }} <span class='text-asterisks text-sm'>*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text">
                                        <i class='bx bx-lock fs-4'></i>

                                    </span>
                                    <input type="password" class="form-control show_new_password" name="password" placeholder="Enter new password" />
                                    <span class="input-group-text cursor-pointer toggle_new_password"><i class="bx bx-hide"></i></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="form-label">{{ labels('admin_labels.confirm_new_password', 'Confirm new password') }}
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control show_confirm_password" name="password_confirmation" placeholder="Confirm new password" />
                                    <span class="input-group-text cursor-pointer toggle_confirm_password"><i class="bx bx-hide"></i></span>

                                </div>
                            </div>
                            <button type="submit" class="btn btn-lg btn-primary login_button w-100 mt-4 mb-0">{{ labels('admin_labels.reset_password', 'Reset Password') }}</button>
